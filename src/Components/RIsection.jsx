  ...
  return (
    <div className='  mt-8'>
        ...
        <div className='mx-auto max-w-6xl flex '>
          ...
          <p class="text-3xl font-normal sm:text-5xl md:mb-1 md:text-2xl pt-14  mr-32  text-white  "> <span className={` ${props.gradcolor}  text-transparent bg-clip-text text-3xl mr-32`} >
          ...
          <div className=' flex-row  gap-2.5  sm:justify-center w-1/2 p-4 '>
              ...
              <img className="rounded-xl" src={props.src} alt=''  width={750} height={650} sizes='cover'/> 
