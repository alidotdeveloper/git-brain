    ...
    <div className='  mt-8'>
      <div className='flex m-2 flex-col gap-2.5 sm:flex-row sm:justify-center'>
        ...
        <div className='mx-auto max-w-6xl flex '>
          ...
          <p class="text-3xl font-semibold sm:text-5xl md:mb-1 md:text-2xl pt-2 mr-16  text-white "> <span className={` ${props.gradcolor}  text-transparent bg-clip-text text-3xl`} >
