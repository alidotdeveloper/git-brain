...
function LIsection(props) {
  return (
    <div className={` pt-8 ${props.grad}  w-full`}>
      ...
      <div className='mx-auto max-w-7xl flex '>
        ...
        <div className='m-4 flex-row gap-2.5  sm:justify-center  w-1/3 '>
            
          <p class="text-3xl font-normal sm:text-5xl md:mb-1 md:text-2xl pt-14   text-white"> <span
            className={`${props.gradcolor} mr-64  text-transparent bg-clip-text text-3xl 
                ...
                <p className='mb-3 mt-4 text-base font-light sm:text-5xl md:mb-0 md:text-base   text-gray-300/90
                '>
                    {props.summary}
           </p>
        </div>
