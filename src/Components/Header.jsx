...
function Header() {
    ...
    return (
        ...
        <div class="container mx-auto flex flex-wrap p-5 pl-3 pr-3  md:flex-row   items-center ">
          ...
          <button class="rounded bg-green-950 text-gray-400 font-medium inline-flex items-center hidden  border-0 py-1 px-3 focus:outline-none hover:bg-{#173D43} text-white mt-2 md:mt-0 ">Download
          </button>
        </div>
      </header>
  )
